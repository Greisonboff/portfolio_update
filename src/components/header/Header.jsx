    ...
    return (
        <div className="flex justify-between sm:justify-center align-baseline my-4 h-8 border-b-2 dark:border-slate-200 border-slate-800 pb-10">
            <div className="mx-6 sm:mx-3 h-8 relative sm:hidden">
                { iconMenu != true ? <GiHamburgerMenu className="dark:text-gray-100 h-6 w-6 sm:hidden" onClick={ativaMenu} />
                :  <AiOutlineCloseSquare className="dark:text-gray-100 h-6 w-6 sm:hidden" onClick={ativaMenu} />}
            </div>
            <LogoImg />
